...
public class calenadariolinea extends Fragment {

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_calenadariolinea, container, false);
        ...
        cals.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String imagen = snapshot.child("calendariolinea").getValue().toString();
                ZoomageView sabcal = view.findViewById(R.id.calendariolinea);
